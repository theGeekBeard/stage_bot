            ...
            for items in await db.get_users():
                if items[1] == datetime.now().date():
                    ...
                    text_del = _("Привет, {name}! Сегодня у вас истек срок подписки на телеграм-канал “Пой со мной”. Мы, "
                             "я вынуждены удалить вас из канала, за то что вы не продлили подписку, таковы правила. "
                             "Вам всегда доступна бесплатная версия канала https://t.me/Sing_with_me_folk "
                             "В любой момент вы можете вернуться к нам. Для этого  нажмите “Хочу подписку” в Меню. Буду "
